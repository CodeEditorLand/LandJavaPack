...
> Note: if you are modifying a project that was already opened in VS Code
...
[`collaboration`](https://github.com/SonarSource/sonarlint-vscode/pull/28)
between the team members from SonarLint, Red Hat and Microsoft. The extension
runs in the background and highlights code that poses a quality or security
concern. Enjoy!
...
Here to mention a new way of creating a class. Now, when you create a `.java`
...
using [`Eclipse MicroProfile`](https://microprofile.io/). You can quickly
generate a MicroProfile project and utilize development tools for runtimes such
as [`Open Liberty](https://openliberty.io/) and [Quarkus`](https://quarkus.io/).
